...
import { ZkBattleshipGame } from './games/zk-battleship/ZkBattleshipGame';

const GAME_ID = 'zk-battleship';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'ZK Treasure Hunt';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZK_BATTLESHIP_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
