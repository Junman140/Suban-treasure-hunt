...
export interface WalletState {
  ...
  walletType: 'dev' | 'wallet' | 'embedded' | null; // dev, extension (Freighter/Kit), or embedded (sessionStorage)
  isConnected: boolean;
  ...
  // Actions
  setWallet: (publicKey: string, walletId: string, walletType: 'dev' | 'wallet' | 'embedded') => void;
