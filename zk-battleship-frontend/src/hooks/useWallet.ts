...
export function useWallet() {
  ...
  /**
   * Create a new local game wallet (Keypair.random(), store in localStorage). No confirmations for signing.
   */
  ...
  /**
   * Import secret key into local wallet (store in localStorage, sign in-browser)
   */
  ...
  /**
   * Restore connection from a previously saved local wallet (localStorage)
   */
  ...
  /**
   * Disconnect wallet (local wallet stays in localStorage until "Clear saved wallet")
   */
  ...
  /**
   * Whether a local wallet is saved in localStorage (can restore)
   */
